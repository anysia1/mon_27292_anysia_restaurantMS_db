...
##  PL/SQL Capstone - Phase II: Business Process Modeling
...
-  MENU ↔ ORDER_ITEMS — One-to-Many  
-  ORDERS ↔ ORDER_ITEMS — One-to-Many  
-  MENU ↔ INVENTORY — One-to-One  
...
## Phase IV: Database Creation and Access Setup (via SQL Developer)
...
| PDB Name          | `MON_27292_Anysia_RESTO_DB`        |
| User Created      | `anysia123`                           |
| Password          | `123`                                |
...
ALTER SESSION SET CONTAINER = MON_27292_ANYSIA_RESTO_DB;

-- Create the project user
CREATE USER anysia123 IDENTIFIED BY 123;

-- Grant access privileges
GRANT CONNECT, RESOURCE TO anysia123;
GRANT DBA TO anysia123;

-- Set default tablespace and quota
ALTER USER anysia123 DEFAULT TABLESPACE users;
ALTER USER anysia123 QUOTA UNLIMITED ON users;

-- Check user status
SELECT username, account_status 
FROM dba_users 
WHERE username = 'anysia123';
```    
...
✅ The following tables were created in the schema `MON_27292_anysia_restaurant_db` using SQL Developer:
...
###  Step 4: Constraints and Integrity
...
Restaurant systems are vulnerable to **accidental or unauthorized changes** during high-volume or sensitive periods. This phase implements:
 ...
 Tracking who attempted changes and when  
